var ddsmoothmenu={arrowimages:{down:['downarrowclass','images/blank.gif'],right:['rightarrowclass','images/blank.gif']},transition:{overtime:400,outtime:600},shadow:{enabled:true,offsetx:0,offsety:0},detectwebkit:navigator.userAgent.toLowerCase().indexOf("applewebkit")!=-1,detectie6:document.all&&!window.XMLHttpRequest,getajaxmenu:function($,setting){var $menucontainer=$('#'+setting.contentsource[0])
...
$mainmenu.parent().get(0).className=setting.classname||"smoothmenu"
...
document.write('<style type="text/css">\n'+mainselector+' ul li a {background:'+setting.customtheme[0]+';}\n'+mainmenuid+' ul li a:hover {background:'+setting.customtheme[1]+';}\n'+'</style>')}this.shadow.enabled=(document.all&&!window.XMLHttpRequest)?false:true
